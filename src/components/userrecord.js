...
class UserRecordList extends Component {
  render() {
    const { user_record, message } = this.props
    if(message){
      return (
  ...
  render() {
    return (
      <div className="UserRecord">
        <UserRecordList user_record={this.props.user_record} message={this.props.message} />
        {/*<div className="row">*/}
          <div className="col-sm-12">
            <PendingRecordList user_record={this.props.user_record} />
          </div>
          <div className="col-sm-12">
            <ApprovedRecordList user_record={this.props.user_record} />
          </div>
        {/*</div>*/}
      </div>
    );
