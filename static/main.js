...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leavecalendar = __webpack_require__(231);
	...
	_reactDom2.default.render(_react2.default.createElement(PageContent, null), document.getElementById('body content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginForm = function (_React$Component) {
	  ...
	  function LoginForm(props) {
	    ...
	    _this.state = { email: '', password: '', message: '' };
	...
	var LoginBox = function (_React$Component2) {
	  ...
	  _createClass(LoginBox, [{
	    ...
	    value: function handleFormSubmit(login, callback) {
	      $.ajax({
	        url: url,
	        dataType: 'json',
	        type: 'POST',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecordList = function (_React$Component2) {
	  ...
	  function RecordList() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(RecordList).apply(this, arguments));
	  }
	...
	var LeaveCalendar = function (_React$Component3) {
	  ...
	  _createClass(LeaveCalendar, [{
	    key: 'loadRecordsFromServer',
	    value: function loadRecordsFromServer() {
	      var _this4 = this;
